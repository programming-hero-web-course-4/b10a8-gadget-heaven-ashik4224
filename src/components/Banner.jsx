...
const Banner = () => {
    ...
    return (
        <div className="mb-20 px-3  lg:px-0 ">
            <div className="bg-[#9538E2] -mt-20 rounded-2xl">
                <div className=" container mx-auto text-white pt-32 pb-36 lg:pb-44 ">
                    <div className="hero-content text-center">
                        <div className="ml-44 lg:w-3/4 px-5">
                            ...
                            <button onClick={goToDashboard} className="rounded-full px-10 py-4 bg-white text-[#9538E2] text-xl font-bold textColor">Shop Now</button>
                        </div>
                    </div>
            ...
            <div className="flex justify-center mr-16 px-6 md:px-0 -mt-28 lg:-mt-40">
