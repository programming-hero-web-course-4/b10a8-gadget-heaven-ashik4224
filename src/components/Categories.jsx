...
//     return (
//         <div className="container w-12/12 mx-auto mt-64">
//             <div
//                 role="tablist"
//                 className="lg:items-start mx-4 lg:mx-0 lg:ml-20 tabs tabs-boxed border border-gray-300 bg-white p-5 rounded-xl space-y-3 flex flex-wrap md:flex-nowrap lg:flex-col lg:w-[250px]"
//             >
...
//                         role="tab"
//                         className={({ isActive }) =>
//                             `tab w-full h-12 !rounded-full font-semibold bg-gray-200 hover:bg-[#4b39f5] hover:text-white ${
//                                 isActive ? "tab-active" : ""
//                             }`
//                         }
//                     >
